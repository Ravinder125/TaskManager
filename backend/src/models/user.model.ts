...
import { IUser, IUserMethods, UserDocument } from "../types/models/user.model.type.js";
...
if (!ACCESS_TOKEN_EXPIRES_IN || !REFRESH_TOKEN_EXPIRES_IN) {
    console.error(ACCESS_TOKEN_EXPIRES_IN, REFRESH_TOKEN_EXPIRES_IN, ACCESS_TOKEN_EXPIRY)
