            ...
            <table className='min-w-full'>
                <thead >
                    <tr className='text-left'>
                        ...
                        <th className='py-3 px-4 text-gray-800 font-medium text-[13px] hidden md:table-cells'>Created On</th>
                    </tr>
                </thead>
                <tbody>
                    {tableData && tableData.map((task, idx) => (
                        <tr key={idx} className=''>
                            ...
                            <td className='p-4 text-gray-700 text-[13px] text-nowrap hidden md:table-cell'>{task.createAt ? moment(task.createdAt).format('Do MMM YYYY') : 'N/A'}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
