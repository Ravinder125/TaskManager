...
const Modal = ({ children, isOpen, onClose, title }) => {
    ...
    return (
        <div className='fixed top-0 right-0 left-0 z-100 flex justify-center items-center w-full h-full max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50'>
